...
const data = [
  ...
  },
  {
    title: 'cls',
    date: '2023-06-14',
    firstParagraph: 'First paragraph of article 1',
    secondParagraph: 'Second paragraph of article 1',
    thirdParagraph: 'Third paragraph of article 1'
  },
];
...
data.forEach(article => {
  articlesContainer.appendChild(articleMaker(article));
});
